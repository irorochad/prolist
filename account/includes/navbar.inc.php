    ...
    <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
        <div class="container flex items-center justify-between md:justify-end h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
                <a href="/prolist/projects" class="text-gray-800 dark:text-gray-100">Back to Explore</a>
            ...
            <div class="group inline-block relative md:w-1/5 md:ml-10">
                ...
                <ul class="absolute hidden bg-gray-300 dark:bg-gray-700 pt-1 group-hover:block">
                    <li class="">
                        <a class="rounded-t text-gray-600 dark:text-gray-100 hover:underline py-2 px-4 block whitespace-no-wrap" href="#">One</a>
                    </li>
                    <li class="">
