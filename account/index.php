...
<main class="h-full overflow-y-auto">
  ...
  <div class="container px-6 mx-auto grid">
    ...
    <h4 class="mb-3 font-light text-gray-700 dark:text-gray-200">Welcome Admin, {First Name}</h4>
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
      ...
      <div class="flex items-center justify-between  p-4 bg-white rounded-lg transition-shadow ease-in-out delay-150 hover:shadow-xl dark:bg-gray-800">
        ...
        <a type="button" href="#" class="text-white bg-gray-700 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-1 mr-2 mb-2 dark:bg-gray-700  dark:focus:ring-gray-700 dark:border-gray-700">View</a>
      </div>
      <!-- Card -->
