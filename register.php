...
<main class="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-slate-900 space-y-10 py-12 px-4 sm:px-6 lg:px-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Or
                <a href="./login.php" class="font-medium text-indigo-600 border-b border-indigo-600"> Sign in to your account </a>
            </p>
        </div>
        <form action="register.php" method="post" class="w-full">
            <div class="max-w-md w-full mx-auto bg-white dark:bg-[#77325f2d] rounded-lg p-7 space-y-6">
                <div class="flex flex-col">
                    <label class="text-sm font-bold text-gray-600 dark:text-gray-100 mb-1" for="Fname">First Name</label>
                    <input class="border rounded-md bg-white dark:bg-slate-300 px-3 py-2" type="text" name="Fname" id="Fname" placeholder="e.g: John" />
                </div>
                <div class="flex flex-col">
                    <label class="text-sm font-bold text-gray-600 dark:text-gray-100  mb-1" for="Lname">Last Name</label>
                    <input class="border rounded-md bg-white dark:bg-slate-300 px-3 py-2" type="text" name="Lname" id="Lname" placeholder="e.g: Doe" />
                </div>
                <div class="flex flex-col">
                ...
                <div>
                    <button class="w-full bg-indigo-600 text-white rounded-md p-2">Create Account</button>
                </div>
            </div>
        </form>
    </main>
