...
<section>
  <div class="container mt-8 md:mt-12 mx-auto px-5 md:px-0">
    ...
    <div class="owl-carousel">
      <div class="swiper-slide max-w-sm mx-auto mb-5 md:mr-5  h-fit w-fit bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="swiper-slide max-w-sm mx-auto mb-5 md:mr-5  h-fit w-fit bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex flex-row justify-between items-center">
          ...
          <img class="w-1/3" src="./assets/img/binance.png" alt="LOGO">
